...
func ToFloat(v interface{}) (float64, error) {
	...
	return 0.0, errors.New("cannot convert value [" + vV.String() + "] to float64")
}
...
func ToInt(v interface{}) (int64, error) {
	...
	return 0, errors.New("cannot convert value [" + vV.String() + "] to int64")
}
...
func ToUint(v interface{}) (uint64, error) {
	...
	return 0, errors.New("cannot convert value [" + vV.String() + "] to uint64")
}
